        ...
        <div class="md-layout">
           ...
           <h4 class="title">
            ...
            <div class="card-description">
               ...
               <div>
                  <div>From : {{ item.startdate|moment("DD-MM-YYYY")}} &emsp;&emsp;&emsp;&emsp;&emsp;To : {{ item.enddate|moment("DD-MM-YYYY")}}
              </div>
...
<script>
    ...
    export default {
        ...
        created: function() {
            ...
            axios.get('http://192.168.0.104:3200/api/sponseredCampaign', {
                    headers: {
